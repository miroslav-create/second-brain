...
> Online broker (PL). Pro Fund Snoop: jen headline ETFs jako metadata (viz [[ADR-0002 broker scope]]).
...
Phase C scaffold. Stejný pattern jako [[Provider - Trading212]] — `management_note` + curated instruments, žádný text-extract.

## Scraper

- Modul: `fund_snoop/providers/xtb.py`
...
Repo `HANDOVER.md` + `fund_snoop/providers/xtb.py`.
